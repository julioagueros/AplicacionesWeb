<div class="resources index">
	...
	<tr>
		...
		<td><?php echo $this->Html->link($resource['Resource']['title'],
array('controller' => 'resources', 'action' => 'download', $resource['Resource']['id'])); ?>&nbsp;</td>
		<td><?php echo h($resource['Resource']['description']); ?>&nbsp;</td>
		<td><?php echo h($resource['Resource']['data']); ?>&nbsp;</td>
